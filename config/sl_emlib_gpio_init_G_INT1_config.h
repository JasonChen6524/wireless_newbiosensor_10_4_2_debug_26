#ifndef SL_EMLIB_GPIO_INIT_G_INT1_CONFIG_H
#define SL_EMLIB_GPIO_INIT_G_INT1_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_G_INT1_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_G_INT1_MODE        gpioModeInputPull

// <o SL_EMLIB_GPIO_INIT_G_INT1_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_G_INT1_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_G_INT1
// $[GPIO_SL_EMLIB_GPIO_INIT_G_INT1]
#define SL_EMLIB_GPIO_INIT_G_INT1_PORT           gpioPortB
#define SL_EMLIB_GPIO_INIT_G_INT1_PIN            1
// [GPIO_SL_EMLIB_GPIO_INIT_G_INT1]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_G_INT1_CONFIG_H
