#ifndef SL_EMLIB_GPIO_INIT_EN5V_CONFIG_H
#define SL_EMLIB_GPIO_INIT_EN5V_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_EN5V_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_EN5V_MODE        gpioModeWiredAnd

// <o SL_EMLIB_GPIO_INIT_EN5V_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_EN5V_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_EN5V
// $[GPIO_SL_EMLIB_GPIO_INIT_EN5V]
#define SL_EMLIB_GPIO_INIT_EN5V_PORT             gpioPortC
#define SL_EMLIB_GPIO_INIT_EN5V_PIN              0
// [GPIO_SL_EMLIB_GPIO_INIT_EN5V]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_EN5V_CONFIG_H
