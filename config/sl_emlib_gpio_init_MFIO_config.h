#ifndef SL_EMLIB_GPIO_INIT_MFIO_CONFIG_H
#define SL_EMLIB_GPIO_INIT_MFIO_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_MFIO_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_MFIO_MODE        gpioModeInputPull

// <o SL_EMLIB_GPIO_INIT_MFIO_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_MFIO_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_MFIO
// $[GPIO_SL_EMLIB_GPIO_INIT_MFIO]
#define SL_EMLIB_GPIO_INIT_MFIO_PORT             gpioPortA
#define SL_EMLIB_GPIO_INIT_MFIO_PIN              4
// [GPIO_SL_EMLIB_GPIO_INIT_MFIO]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_MFIO_CONFIG_H
