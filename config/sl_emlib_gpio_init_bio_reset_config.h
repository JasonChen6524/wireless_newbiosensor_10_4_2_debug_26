#ifndef SL_EMLIB_GPIO_INIT_BIO_RESET_CONFIG_H
#define SL_EMLIB_GPIO_INIT_BIO_RESET_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_BIO_RESET_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_BIO_RESET_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_BIO_RESET_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_BIO_RESET_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_BIO_RESET
// $[GPIO_SL_EMLIB_GPIO_INIT_BIO_RESET]
#define SL_EMLIB_GPIO_INIT_BIO_RESET_PORT        gpioPortB
#define SL_EMLIB_GPIO_INIT_BIO_RESET_PIN         0
// [GPIO_SL_EMLIB_GPIO_INIT_BIO_RESET]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_BIO_RESET_CONFIG_H
