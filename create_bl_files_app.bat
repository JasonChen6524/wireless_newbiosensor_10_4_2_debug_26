...
@echo DATECODE= '!YEAR!!MON!!DAY!_!HOUR!!MIN!_!SEC!' 
set DATECODE=!YEAR!!MON!!DAY!_!HOUR!!MIN!_!SEC!
...
set PATH_GBL_APP="%PATH_PROJ%\output_gbl_app"
...
echo **********************************************************************
echo.
%OBJCOPY% -O srec -R .text_apploader* -R .text_signature* "%PATH_OUT%" "%PATH_GBL_APP%\%OTA_APPLI_NAME%.srec"
...
%COMMANDER% gbl create "%PATH_GBL_APP%\%ART_APPLI_NAME%%DATECODE%.gbl" --app "%PATH_GBL_APP%\%OTA_APPLI_NAME%.srec"
